    ...
    <div className="min-h-screen bg-[#1a1a1a]">
      ...
      <main className="max-w-6xl mx-auto px-6 py-5">
        ...
        <div className="mb-5">
          ...
          <p className="text-[#6e6e6e] mt-0.5 text-sm">Gestiona tus videoconferencias</p>
        </div>
...
function StatCard({ icon, label, value, color }: {
  ...
  return (
    <div className="bg-[#242424] border border-white/10 rounded-xl p-3.5">
      <div className={`w-8 h-8 ${bg} rounded-lg flex items-center justify-center mb-2.5`}>
        {icon}
      </div>
      <p className="text-xl font-bold text-white">{value}</p>
      <p className="text-xs text-[#6e6e6e] mt-0.5">{label}</p>
    </div>
  );
}
